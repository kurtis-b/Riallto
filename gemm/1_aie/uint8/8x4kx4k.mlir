module  {
   ...
   %tile00 = AIE.tile(0, 0)
   %tile02 = AIE.tile(0, 2)
   AIE.objectFifo @itbuffer_0___ITout___mmul_start_0___pA(%tile00, {%tile02}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   ...
   AIE.core(%tile02) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         %subview1 = AIE.objectFifo.acquire @itbuffer_0___ITout___mmul_start_0___pA(Consume, 1) : !AIE.objectFifoSubview<memref<256xi32>>
         %elem1 = AIE.objectFifo.subview.access %subview1[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>
         ...
         func.call @mmul_start(%elem1, %elem2, %elem3) : (memref<256xi32>, memref<2048xi32>, memref<256xi32>) -> ()
...
func.func @sequence(%itbuffer_0 : memref<4x64xi32>,%itbuffer_1 : memref<64x32xi32>,%itbuffer_2 : memref<8x32xi32>) {
    ...
    AIEX.ipu.dma_memcpy_nd(%c0, %c0,%itbuffer_0[%c0, %c0, %c0, %c0][%c1, %c1, %c4, %c64][%c0, %c0, %c0]){ metadata= @itbuffer_0___ITout___mmul_start_0___pA, id = 0 : i32 } :(i32, i32, memref<4x64xi32>, [i32,i32,i32,i32], [i32,i32,i32,i32], [i32,i32,i32])
