module  {
   ...
   AIE.core(%tile02) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem1, %elem2, %elem3) : (memref<1024xi32>, memref<1024xi32>, memref<1024xi32>) -> ()
...
func.func @sequence(%itbuffer_0 : memref<64x16xi32>,%itbuffer_1 : memref<64x16xi32>,%itbuffer_2 : memref<64x16xi32>) {
    ...
    AIEX.ipu.dma_memcpy_nd(%c0, %c0,%itbuffer_2[%c0, %c0, %c0, %c0][%c1, %c1, %c64, %c16][%c0, %c0, %c0]){ metadata= @mmul_start_0___pC___itbuffer_2___ITin, id = 2 : i32 } :(i32, i32, memref<64x16xi32>, [i32,i32,i32,i32], [i32,i32,i32,i32], [i32,i32,i32])
