module  {
   ...
   AIE.core(%tile02) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem1, %elem2, %elem3) : (memref<1024xi32>, memref<2048xi32>, memref<2048xi32>) -> ()
...
func.func @sequence(%itbuffer_0 : memref<32x32xi32>,%itbuffer_1 : memref<128x16xi32>,%itbuffer_2 : memref<32x64xi32>) {
    ...
    AIEX.ipu.dma_memcpy_nd(%c0, %c0,%itbuffer_2[%c0, %c0, %c0, %c0][%c1, %c1, %c32, %c64][%c0, %c0, %c0]){ metadata= @mmul_start_0___pC___itbuffer_2___ITin, id = 2 : i32 } :(i32, i32, memref<32x64xi32>, [i32,i32,i32,i32], [i32,i32,i32,i32], [i32,i32,i32])
    ...
    AIEX.ipu.dma_memcpy_nd(%c0, %c0,%itbuffer_1[%c0, %c0, %c0, %c0][%c1, %c1, %c128, %c16][%c0, %c0, %c0]){ metadata= @itbuffer_1___ITout___mmul_start_0___pB, id = 1 : i32 } :(i32, i32, memref<128x16xi32>, [i32,i32,i32,i32], [i32,i32,i32,i32], [i32,i32,i32])
