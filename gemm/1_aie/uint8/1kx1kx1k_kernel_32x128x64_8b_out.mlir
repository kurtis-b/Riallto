module  {
   ...
   AIE.core(%tile02) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem1, %elem2, %elem3) : (memref<1024xi32>, memref<2048xi32>, memref<512xi32>) -> ()
...
func.func @sequence(%itbuffer_0 : memref<32x32xi32>,%itbuffer_1 : memref<128x16xi32>,%itbuffer_2 : memref<32x16xi32>) {
