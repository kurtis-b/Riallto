...
WORKLOADS = [
    ...
    },
    {
        ...
        DATA_TYPE_INPUT_KEY: 'i8',
        DATA_TYPE_OUTPUT_KEY: 'i32',
        NPU_SHAPES_KEY: [(32, 128), (128, 64), (32, 64)],  # A, B, C
    ...
    },
    {
        ...
        DATA_TYPE_INPUT_KEY: 'bfloat16',
        DATA_TYPE_OUTPUT_KEY: 'f32',
        NPU_SHAPES_KEY: [(32, 64), (64, 64), (32, 64)],  # A, B, C
    ...
    },
    {
        ...
        DATA_TYPE_INPUT_KEY: 'i8',
        DATA_TYPE_OUTPUT_KEY: 'i32',
        NPU_SHAPES_KEY: [(8, 512), (512, 16), (8, 16)],  # A, B, C
    ...
    },
    {
        ...
        DATA_TYPE_INPUT_KEY: 'bfloat16',
        DATA_TYPE_OUTPUT_KEY: 'f32',
        NPU_SHAPES_KEY: [(8, 256), (256, 16), (8, 16)],  # A, B, C
