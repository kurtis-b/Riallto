module  {
   ...
   AIE.objectFifo @mmul_start_0___pC___itbuffer_2___ITin(%tile02, {%tile00}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   ...
   AIE.core(%tile02) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         %subview3 = AIE.objectFifo.acquire @mmul_start_0___pC___itbuffer_2___ITin(Produce, 1) : !AIE.objectFifoSubview<memref<256xi32>>
         %elem3 = AIE.objectFifo.subview.access %subview3[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>

         func.call @mmul_start(%elem1, %elem2, %elem3) : (memref<1024xi32>, memref<4096xi32>, memref<256xi32>) -> ()
...
func.func @sequence(%itbuffer_0 : memref<8x128xi32>,%itbuffer_1 : memref<256x16xi32>,%itbuffer_2 : memref<8x32xi32>) {
