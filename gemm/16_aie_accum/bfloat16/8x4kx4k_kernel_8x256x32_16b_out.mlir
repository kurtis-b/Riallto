module  {
   ...
   func.func private @mmul_accum(memref<1024xi32>, memref<4096xi32>, memref<128xi32>, memref<128xi32>) -> ()
   func.func private @mmul_end(memref<1024xi32>, memref<4096xi32>, memref<128xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile04) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_accum(%elem11, %elem4, %elem9, %elem8) : (memref<1024xi32>, memref<4096xi32>, memref<128xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile03) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_accum(%elem11, %elem3, %elem8, %elem7) : (memref<1024xi32>, memref<4096xi32>, memref<128xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile02) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_end(%elem11, %elem2, %elem7, %elem6) : (memref<1024xi32>, memref<4096xi32>, memref<128xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile14) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_accum(%elem16, %elem14, %elem17, %elem18) : (memref<1024xi32>, memref<4096xi32>, memref<128xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile13) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_accum(%elem16, %elem13, %elem18, %elem19) : (memref<1024xi32>, memref<4096xi32>, memref<128xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile12) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_end(%elem16, %elem12, %elem19, %elem20) : (memref<1024xi32>, memref<4096xi32>, memref<128xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile24) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_accum(%elem25, %elem23, %elem26, %elem27) : (memref<1024xi32>, memref<4096xi32>, memref<128xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile23) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_accum(%elem25, %elem22, %elem27, %elem28) : (memref<1024xi32>, memref<4096xi32>, memref<128xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile22) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_end(%elem25, %elem21, %elem28, %elem29) : (memref<1024xi32>, memref<4096xi32>, memref<128xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile34) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_accum(%elem34, %elem32, %elem35, %elem36) : (memref<1024xi32>, memref<4096xi32>, memref<128xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile33) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_accum(%elem34, %elem31, %elem36, %elem37) : (memref<1024xi32>, memref<4096xi32>, memref<128xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile32) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_end(%elem34, %elem30, %elem37, %elem38) : (memref<1024xi32>, memref<4096xi32>, memref<128xi32>, memref<128xi32>) -> ()
...
func.func @sequence(%itbuffer_0 : memref<8x512xi32>,%itbuffer_1 : memref<1024x64xi32>,%itbuffer_2 : memref<8x64xi32>) {
