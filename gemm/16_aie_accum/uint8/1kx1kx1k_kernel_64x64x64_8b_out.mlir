module  {
   ...
   func.func private @mmul_accum(memref<1024xi32>, memref<1024xi32>, memref<1024xi32>, memref<1024xi32>) -> ()
   func.func private @mmul_end(memref<1024xi32>, memref<1024xi32>, memref<1024xi32>, memref<1024xi32>) -> ()
   ...
   AIE.core(%tile04) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_accum(%elem11, %elem4, %elem9, %elem8) : (memref<1024xi32>, memref<1024xi32>, memref<1024xi32>, memref<1024xi32>) -> ()
   ...
   AIE.core(%tile03) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_accum(%elem11, %elem3, %elem8, %elem7) : (memref<1024xi32>, memref<1024xi32>, memref<1024xi32>, memref<1024xi32>) -> ()
   ...
   AIE.core(%tile02) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_end(%elem11, %elem2, %elem7, %elem6) : (memref<1024xi32>, memref<1024xi32>, memref<1024xi32>, memref<1024xi32>) -> ()
   ...
   AIE.core(%tile14) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_accum(%elem16, %elem14, %elem17, %elem18) : (memref<1024xi32>, memref<1024xi32>, memref<1024xi32>, memref<1024xi32>) -> ()
   ...
   AIE.core(%tile13) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_accum(%elem16, %elem13, %elem18, %elem19) : (memref<1024xi32>, memref<1024xi32>, memref<1024xi32>, memref<1024xi32>) -> ()
   ...
   AIE.core(%tile12) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_end(%elem16, %elem12, %elem19, %elem20) : (memref<1024xi32>, memref<1024xi32>, memref<1024xi32>, memref<1024xi32>) -> ()
   ...
   AIE.core(%tile24) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_accum(%elem25, %elem23, %elem26, %elem27) : (memref<1024xi32>, memref<1024xi32>, memref<1024xi32>, memref<1024xi32>) -> ()
   ...
   AIE.core(%tile23) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_accum(%elem25, %elem22, %elem27, %elem28) : (memref<1024xi32>, memref<1024xi32>, memref<1024xi32>, memref<1024xi32>) -> ()
   ...
   AIE.core(%tile22) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_end(%elem25, %elem21, %elem28, %elem29) : (memref<1024xi32>, memref<1024xi32>, memref<1024xi32>, memref<1024xi32>) -> ()
   ...
   AIE.core(%tile34) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_accum(%elem34, %elem32, %elem35, %elem36) : (memref<1024xi32>, memref<1024xi32>, memref<1024xi32>, memref<1024xi32>) -> ()
   ...
   AIE.core(%tile33) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_accum(%elem34, %elem31, %elem36, %elem37) : (memref<1024xi32>, memref<1024xi32>, memref<1024xi32>, memref<1024xi32>) -> ()
   ...
   AIE.core(%tile32) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_end(%elem34, %elem30, %elem37, %elem38) : (memref<1024xi32>, memref<1024xi32>, memref<1024xi32>, memref<1024xi32>) -> ()
...
func.func @sequence(%itbuffer_0 : memref<64x64xi32>,%itbuffer_1 : memref<256x64xi32>,%itbuffer_2 : memref<64x64xi32>) {
    ...
    AIEX.ipu.dma_memcpy_nd(%c0, %c0,%itbuffer_2[%c0, %c0, %c0, %c0][%c1, %c1, %c64, %c16][%c0, %c0, %c64]){ metadata= @mtbuffer_2___MTout___itbuffer_2___ITin_00, id = 2 : i32 } :(i32, i32, memref<64x64xi32>, [i32,i32,i32,i32], [i32,i32,i32,i32], [i32,i32,i32])
    ...
    AIEX.ipu.dma_memcpy_nd(%c0, %c0,%itbuffer_2[%c0, %c0, %c0, %c16][%c1, %c1, %c64, %c16][%c0, %c0, %c64]){ metadata= @mtbuffer_2___MTout___itbuffer_2___ITin_10, id = 5 : i32 } :(i32, i32, memref<64x64xi32>, [i32,i32,i32,i32], [i32,i32,i32,i32], [i32,i32,i32])
    ...
    AIEX.ipu.dma_memcpy_nd(%c0, %c0,%itbuffer_2[%c0, %c0, %c0, %c32][%c1, %c1, %c64, %c16][%c0, %c0, %c64]){ metadata= @mtbuffer_2___MTout___itbuffer_2___ITin_20, id = 8 : i32 } :(i32, i32, memref<64x64xi32>, [i32,i32,i32,i32], [i32,i32,i32,i32], [i32,i32,i32])
    ...
    AIEX.ipu.dma_memcpy_nd(%c0, %c0,%itbuffer_2[%c0, %c0, %c0, %c48][%c1, %c1, %c64, %c16][%c0, %c0, %c64]){ metadata= @mtbuffer_2___MTout___itbuffer_2___ITin_30, id = 11 : i32 } :(i32, i32, memref<64x64xi32>, [i32,i32,i32,i32], [i32,i32,i32,i32], [i32,i32,i32])
