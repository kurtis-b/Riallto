module  {
   ...
   AIE.objectFifo @mmul_start_05___pC___mtbuffer_2___MTin_01(%tile05, {%tile01}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   AIE.objectFifo @mmul_start_04___pC___mtbuffer_2___MTin_01(%tile04, {%tile01}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   AIE.objectFifo @mmul_start_03___pC___mtbuffer_2___MTin_01(%tile03, {%tile01}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   AIE.objectFifo @mmul_start_02___pC___mtbuffer_2___MTin_01(%tile02, {%tile01}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   ...
   AIE.objectFifo @mmul_start_15___pC___mtbuffer_2___MTin_11(%tile15, {%tile11}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   AIE.objectFifo @mmul_start_14___pC___mtbuffer_2___MTin_11(%tile14, {%tile11}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   AIE.objectFifo @mmul_start_13___pC___mtbuffer_2___MTin_11(%tile13, {%tile11}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   AIE.objectFifo @mmul_start_12___pC___mtbuffer_2___MTin_11(%tile12, {%tile11}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   ...
   AIE.objectFifo @mmul_start_25___pC___mtbuffer_2___MTin_21(%tile25, {%tile21}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   AIE.objectFifo @mmul_start_24___pC___mtbuffer_2___MTin_21(%tile24, {%tile21}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   AIE.objectFifo @mmul_start_23___pC___mtbuffer_2___MTin_21(%tile23, {%tile21}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   AIE.objectFifo @mmul_start_22___pC___mtbuffer_2___MTin_21(%tile22, {%tile21}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   ...
   AIE.objectFifo @mmul_start_35___pC___mtbuffer_2___MTin_31(%tile35, {%tile31}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   AIE.objectFifo @mmul_start_34___pC___mtbuffer_2___MTin_31(%tile34, {%tile31}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   AIE.objectFifo @mmul_start_33___pC___mtbuffer_2___MTin_31(%tile33, {%tile31}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   AIE.objectFifo @mmul_start_32___pC___mtbuffer_2___MTin_31(%tile32, {%tile31}, 2 : i32) : !AIE.objectFifo<memref<256xi32>>
   ...
   AIE.core(%tile05) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         %subview9 = AIE.objectFifo.acquire @mmul_start_05___pC___mtbuffer_2___MTin_01(Produce, 1) : !AIE.objectFifoSubview<memref<256xi32>>
   ...
   AIE.core(%tile04) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         %subview8 = AIE.objectFifo.acquire @mmul_start_04___pC___mtbuffer_2___MTin_01(Produce, 1) : !AIE.objectFifoSubview<memref<256xi32>>
         %elem8 = AIE.objectFifo.subview.access %subview8[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>

         func.call @mmul_start(%elem11, %elem4, %elem8) : (memref<1024xi32>, memref<4096xi32>, memref<256xi32>) -> ()
   ...
   AIE.core(%tile03) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         %subview7 = AIE.objectFifo.acquire @mmul_start_03___pC___mtbuffer_2___MTin_01(Produce, 1) : !AIE.objectFifoSubview<memref<256xi32>>
         %elem7 = AIE.objectFifo.subview.access %subview7[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>

         func.call @mmul_start(%elem11, %elem3, %elem7) : (memref<1024xi32>, memref<4096xi32>, memref<256xi32>) -> ()
   ...
   AIE.core(%tile02) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         %subview6 = AIE.objectFifo.acquire @mmul_start_02___pC___mtbuffer_2___MTin_01(Produce, 1) : !AIE.objectFifoSubview<memref<256xi32>>
         %elem6 = AIE.objectFifo.subview.access %subview6[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>

         func.call @mmul_start(%elem11, %elem2, %elem6) : (memref<1024xi32>, memref<4096xi32>, memref<256xi32>) -> ()
   ...
   AIE.core(%tile15) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         %subview17 = AIE.objectFifo.acquire @mmul_start_15___pC___mtbuffer_2___MTin_11(Produce, 1) : !AIE.objectFifoSubview<memref<256xi32>>
   ...
   AIE.core(%tile14) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         %subview18 = AIE.objectFifo.acquire @mmul_start_14___pC___mtbuffer_2___MTin_11(Produce, 1) : !AIE.objectFifoSubview<memref<256xi32>>
         %elem18 = AIE.objectFifo.subview.access %subview18[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>

         func.call @mmul_start(%elem16, %elem14, %elem18) : (memref<1024xi32>, memref<4096xi32>, memref<256xi32>) -> ()
   ...
   AIE.core(%tile13) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         %subview19 = AIE.objectFifo.acquire @mmul_start_13___pC___mtbuffer_2___MTin_11(Produce, 1) : !AIE.objectFifoSubview<memref<256xi32>>
         %elem19 = AIE.objectFifo.subview.access %subview19[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>

         func.call @mmul_start(%elem16, %elem13, %elem19) : (memref<1024xi32>, memref<4096xi32>, memref<256xi32>) -> ()
   ...
   AIE.core(%tile12) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         %subview20 = AIE.objectFifo.acquire @mmul_start_12___pC___mtbuffer_2___MTin_11(Produce, 1) : !AIE.objectFifoSubview<memref<256xi32>>
         %elem20 = AIE.objectFifo.subview.access %subview20[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>

         func.call @mmul_start(%elem16, %elem12, %elem20) : (memref<1024xi32>, memref<4096xi32>, memref<256xi32>) -> ()
   ...
   AIE.core(%tile25) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         %subview26 = AIE.objectFifo.acquire @mmul_start_25___pC___mtbuffer_2___MTin_21(Produce, 1) : !AIE.objectFifoSubview<memref<256xi32>>
   ...
   AIE.core(%tile24) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         %subview27 = AIE.objectFifo.acquire @mmul_start_24___pC___mtbuffer_2___MTin_21(Produce, 1) : !AIE.objectFifoSubview<memref<256xi32>>
         %elem27 = AIE.objectFifo.subview.access %subview27[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>

         func.call @mmul_start(%elem25, %elem23, %elem27) : (memref<1024xi32>, memref<4096xi32>, memref<256xi32>) -> ()
   ...
   AIE.core(%tile23) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         %subview28 = AIE.objectFifo.acquire @mmul_start_23___pC___mtbuffer_2___MTin_21(Produce, 1) : !AIE.objectFifoSubview<memref<256xi32>>
         %elem28 = AIE.objectFifo.subview.access %subview28[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>

         func.call @mmul_start(%elem25, %elem22, %elem28) : (memref<1024xi32>, memref<4096xi32>, memref<256xi32>) -> ()
   ...
   AIE.core(%tile22) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         %subview29 = AIE.objectFifo.acquire @mmul_start_22___pC___mtbuffer_2___MTin_21(Produce, 1) : !AIE.objectFifoSubview<memref<256xi32>>
         %elem29 = AIE.objectFifo.subview.access %subview29[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>

         func.call @mmul_start(%elem25, %elem21, %elem29) : (memref<1024xi32>, memref<4096xi32>, memref<256xi32>) -> ()
   ...
   AIE.core(%tile35) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         %subview35 = AIE.objectFifo.acquire @mmul_start_35___pC___mtbuffer_2___MTin_31(Produce, 1) : !AIE.objectFifoSubview<memref<256xi32>>
   ...
   AIE.core(%tile34) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         %subview36 = AIE.objectFifo.acquire @mmul_start_34___pC___mtbuffer_2___MTin_31(Produce, 1) : !AIE.objectFifoSubview<memref<256xi32>>
         %elem36 = AIE.objectFifo.subview.access %subview36[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>

         func.call @mmul_start(%elem34, %elem32, %elem36) : (memref<1024xi32>, memref<4096xi32>, memref<256xi32>) -> ()
   ...
   AIE.core(%tile33) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         %subview37 = AIE.objectFifo.acquire @mmul_start_33___pC___mtbuffer_2___MTin_31(Produce, 1) : !AIE.objectFifoSubview<memref<256xi32>>
         %elem37 = AIE.objectFifo.subview.access %subview37[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>

         func.call @mmul_start(%elem34, %elem31, %elem37) : (memref<1024xi32>, memref<4096xi32>, memref<256xi32>) -> ()
   ...
   AIE.core(%tile32) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         %subview38 = AIE.objectFifo.acquire @mmul_start_32___pC___mtbuffer_2___MTin_31(Produce, 1) : !AIE.objectFifoSubview<memref<256xi32>>
         %elem38 = AIE.objectFifo.subview.access %subview38[0] : !AIE.objectFifoSubview<memref<256xi32>> -> memref<256xi32>

         func.call @mmul_start(%elem34, %elem30, %elem38) : (memref<1024xi32>, memref<4096xi32>, memref<256xi32>) -> ()
...
func.func @sequence(%itbuffer_0 : memref<8x512xi32>,%itbuffer_1 : memref<1024x64xi32>,%itbuffer_2 : memref<32x128xi32>) {
    ...
    AIEX.ipu.dma_memcpy_nd(%c0, %c0,%itbuffer_2[%c0, %c0, %c0, %c0][%c1, %c1, %c8, %c128][%c0, %c0, %c0]){ metadata= @mtbuffer_2___MTout___itbuffer_2___ITin_00, id = 2 : i32 } :(i32, i32, memref<32x128xi32>, [i32,i32,i32,i32], [i32,i32,i32,i32], [i32,i32,i32])
    ...
    AIEX.ipu.dma_memcpy_nd(%c0, %c0,%itbuffer_2[%c0, %c0, %c8, %c0][%c1, %c1, %c8, %c128][%c0, %c0, %c0]){ metadata= @mtbuffer_2___MTout___itbuffer_2___ITin_10, id = 5 : i32 } :(i32, i32, memref<32x128xi32>, [i32,i32,i32,i32], [i32,i32,i32,i32], [i32,i32,i32])
    ...
    AIEX.ipu.dma_memcpy_nd(%c0, %c0,%itbuffer_2[%c0, %c0, %c16, %c0][%c1, %c1, %c8, %c128][%c0, %c0, %c0]){ metadata= @mtbuffer_2___MTout___itbuffer_2___ITin_20, id = 8 : i32 } :(i32, i32, memref<32x128xi32>, [i32,i32,i32,i32], [i32,i32,i32,i32], [i32,i32,i32])
    ...
    AIEX.ipu.dma_memcpy_nd(%c0, %c0,%itbuffer_2[%c0, %c0, %c24, %c0][%c1, %c1, %c8, %c128][%c0, %c0, %c0]){ metadata= @mtbuffer_2___MTout___itbuffer_2___ITin_30, id = 11 : i32 } :(i32, i32, memref<32x128xi32>, [i32,i32,i32,i32], [i32,i32,i32,i32], [i32,i32,i32])
