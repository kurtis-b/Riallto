module  {
   ...
   AIE.core(%tile04) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem11, %elem4, %elem8) : (memref<512xi32>, memref<4096xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile03) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem11, %elem3, %elem7) : (memref<512xi32>, memref<4096xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile02) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem11, %elem2, %elem6) : (memref<512xi32>, memref<4096xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile14) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem16, %elem14, %elem18) : (memref<512xi32>, memref<4096xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile13) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem16, %elem13, %elem19) : (memref<512xi32>, memref<4096xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile12) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem16, %elem12, %elem20) : (memref<512xi32>, memref<4096xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile24) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem25, %elem23, %elem27) : (memref<512xi32>, memref<4096xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile23) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem25, %elem22, %elem28) : (memref<512xi32>, memref<4096xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile22) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem25, %elem21, %elem29) : (memref<512xi32>, memref<4096xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile34) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem34, %elem32, %elem36) : (memref<512xi32>, memref<4096xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile33) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem34, %elem31, %elem37) : (memref<512xi32>, memref<4096xi32>, memref<128xi32>) -> ()
   ...
   AIE.core(%tile32) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem34, %elem30, %elem38) : (memref<512xi32>, memref<4096xi32>, memref<128xi32>) -> ()
...
func.func @sequence(%itbuffer_0 : memref<8x256xi32>,%itbuffer_1 : memref<1024x64xi32>,%itbuffer_2 : memref<32x64xi32>) {
