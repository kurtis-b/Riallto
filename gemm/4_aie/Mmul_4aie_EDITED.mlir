...
func.func @sequence(%itbuffer_0 : memref<64x16xi32>,%itbuffer_1 : memref<256x16xi32>,%itbuffer_2 : memref<256x32xi32>) {
    ...
    AIEX.ipu.dma_memcpy_nd(%c0, %c0,%itbuffer_1[%c0, %c0, %c0, %c0][%c1, %c1, %c256, %c16][%c0, %c0, %c0]){ metadata= @itbuffer_1___ITout___mtbuffer_0___MTin, id = 0 : i32 } :(i32, i32, memref<256x16xi32>, [i32,i32,i32,i32], [i32,i32,i32,i32], [i32,i32,i32])
