module  {
   ...
   %tile04 = AIE.tile(0, 4)
   %tile05 = AIE.tile(0, 5)
   AIE.objectFifo @itbuffer_0___ITout___mtbuffer_0___MTin(%tile00, {%tile01}, 2 : i32) : !AIE.objectFifo<memref<4096xi32>>
   AIE.objectFifo @mtbuffer_0___MTout___mmul_start_0___pA(%tile01, {%tile05}, 2 : i32) : !AIE.objectFifo<memref<1024xi32>>
   ...
   AIE.core(%tile02) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         %subview5 = AIE.objectFifo.acquire @mtbuffer_0___MTout___mmul_start_3___pA(Consume, 1) : !AIE.objectFifoSubview<memref<1024xi32>>
   ...
   AIE.core(%tile03) {
      ...
      %intmax = arith.constant 0xFFFFFFFF : index
      scf.for %arg3 = %c0 to %intmax step %c1 {
         %subview4 = AIE.objectFifo.acquire @mtbuffer_0___MTout___mmul_start_2___pA(Consume, 1) : !AIE.objectFifoSubview<memref<1024xi32>>
   ...
   AIE.core(%tile04) {
      ...
      %intmax = arith.constant 0xFFFFFFFF : index
      scf.for %arg3 = %c0 to %intmax step %c1 {
         %subview3 = AIE.objectFifo.acquire @mtbuffer_0___MTout___mmul_start_1___pA(Consume, 1) : !AIE.objectFifoSubview<memref<1024xi32>>
   ...
   AIE.core(%tile05) {
      ...
      %intmax = arith.constant 0xFFFFFFFF : index
      scf.for %arg3 = %c0 to %intmax step %c1 {
         %subview2 = AIE.objectFifo.acquire @mtbuffer_0___MTout___mmul_start_0___pA(Consume, 1) : !AIE.objectFifoSubview<memref<1024xi32>>
...
func.func @sequence(%itbuffer_0 : memref<256x16xi32>,%itbuffer_1 : memref<64x16xi32>,%itbuffer_2 : memref<256x64xi32>) {
    ...
    AIEX.ipu.dma_memcpy_nd(%c0, %c0,%itbuffer_1[%c0, %c0, %c0, %c0][%c1, %c1, %c64, %c16][%c0, %c0, %c0]){ metadata= @itbuffer_1__ITout, id = 1 : i32 } :(i32, i32, memref<64x16xi32>, [i32,i32,i32,i32], [i32,i32,i32,i32], [i32,i32,i32])
