module  {
   ...
   AIE.core(%tile02) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem5, %elem11, %elem9) : (memref<512xi32>, memref<512xi32>, memref<512xi32>) -> ()
   ...
   AIE.core(%tile03) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem4, %elem11, %elem8) : (memref<512xi32>, memref<512xi32>, memref<512xi32>) -> ()
   ...
   AIE.core(%tile04) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem3, %elem11, %elem7) : (memref<512xi32>, memref<512xi32>, memref<512xi32>) -> ()
   ...
   AIE.core(%tile05) {
      ...
      scf.for %arg3 = %c0 to %intmax step %c1 {
         ...
         func.call @mmul_start(%elem2, %elem11, %elem6) : (memref<512xi32>, memref<512xi32>, memref<512xi32>) -> ()
...
func.func @sequence(%itbuffer_0 : memref<32x16xi32>,%itbuffer_1 : memref<32x64xi32>,%itbuffer_2 : memref<32x64xi32>) {
