...
def execute():
    ...
    with open(performance_file, "w") as f:
        ...
        for workload in WORKLOADS:
            ...
            f.write(f"{4},{inp_dtype},{out_dtype},{workload[WORKLOAD_SHAPES_KEY][0][0]}x{workload[WORKLOAD_SHAPES_KEY][0][1]}x{workload[WORKLOAD_SHAPES_KEY][1][1]},{workload[NPU_SHAPES_KEY][0][0]}x{workload[NPU_SHAPES_KEY][0][1]}x{workload[NPU_SHAPES_KEY][1][1]},{workload[KERNEL_SHAPES_KEY][0][0]}x{workload[KERNEL_SHAPES_KEY][0][1]}x{workload[KERNEL_SHAPES_KEY][1][1]},{total_npu_time},{total_npu_time_plus_ddr_transfer}\n")
